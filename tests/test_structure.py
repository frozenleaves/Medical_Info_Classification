...
def test_imports():
    ...
    tests = [
        ...
        ("数据模块", "from MIC.src.data import MultiModalMedicalDataset, create_dataloaders"),
        ("模型模块", "from MIC.src.models import create_multimodal_model"),
        ("编码器模块", "from MIC.src.models.encoders import create_text_encoder, create_photo_encoder, create_pathology_encoder"),
        ("融合模块", "from MIC.src.models.fusion import create_fusion_module"),
        ("训练模块", "from MIC.src.training import MultiModalTrainer, create_loss_function"),
